...
import com.google.goldcoin.core.StoredTransactionOutput;
import com.google.goldcoin.core.StoredUndoableBlock;
 ...
 * goldcoin serialization of the block header, <b>not</b> the header with the extra data as well.</p>
 * <p/>
 * <p>A FullPrunedBlockStore also contains a map of hash+index to StoredTransactionOutput.  Again, the hash is
 * a standard goldcoin double-SHA256 hash of the transaction.</p>
 * <p/>
