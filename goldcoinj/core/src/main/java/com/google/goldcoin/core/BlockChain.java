...
/**
 * <p>A BlockChain implements the <i>simplified payment verification</i> mode of the goldcoin protocol. It is the right
...
public class BlockChain extends AbstractBlockChain {
     ...
     * </p>
     * <p/>
     * <p>For the store, you should use {@link com.google.goldcoin.store.SPVBlockStore} or you could also try a
     * {@link com.google.goldcoin.store.MemoryBlockStore} if you want to hold all headers in RAM and don't care about
