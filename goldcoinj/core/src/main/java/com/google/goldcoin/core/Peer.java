...
/**
 * A Peer handles the high level communication with a goldcoin node.
 * <p/>
...
public class Peer {
     ...
     * Once the pong is received the value returned by {@link com.google.goldcoin.core.Peer#getLastPingTime()} is
     * updated.
     *
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link com.google.goldcoin.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link com.google.goldcoin.core.Peer#ping()} has never
