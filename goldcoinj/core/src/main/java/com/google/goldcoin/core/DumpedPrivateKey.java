...
/**
 * Parses and generates private keys in the form used by the goldcoin "dumpprivkey" command. This is the private key
...
public class DumpedPrivateKey extends VersionedChecksummedBytes {
    ...
    /**
     * Parses the given private key as created by the "dumpprivkey" goldcoin C++ RPC.
     *
    ...
    public DumpedPrivateKey(NetworkParameters params, String encoded) throws AddressFormatException {
        super(encoded);
        //the Litecoinj people added params.addressHeader to the version in the writing of the file, but not reading of it.
        //So we fix their mistake here.
