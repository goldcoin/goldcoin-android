...
public class VersionMessage extends Message {
     ...
     */
    public static final String GOLDCOINJ_VERSION = "0.8-SNAPSHOT";
    /**
     * The value that is prepended to the subVer field of this application.
     */
    public static final String LIBRARY_SUBVER = "/GoldcoinJ:" + GOLDCOINJ_VERSION + "/";
     ...
     * name:version pairs separated by slashes in the form of a path. For example a typical subVer field for GoldcoinJ
     * users might look like "/goldcoinJ:0.8-SNAPSHOT/MultiBit:1.2/" where libraries come further to the left.<p>
     * <p/>
     ...
     * set of "/GoldcoinJ:1.0/MultiBit:1.0(Windows)/. Therefore the / ( and ) characters are reserved in all these
