...
import com.google.goldcoin.core.Peer.PeerHandler;
...
public class PeerGroup extends AbstractIdleService {
     ...
     * peers. By using this with {@link com.google.goldcoin.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link com.google.goldcoin.core.PeerGroup#getMaxConnections()} returns is used.
     *
     * @return
     */
    ...
    /**
     * See {@link com.google.goldcoin.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * someone and want to know that it's valid. It's a bit of a weird hack because the current version of the goldcoin
     ...
     * times are available via {@link com.google.goldcoin.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link com.google.goldcoin.core.Peer#ping()}.
     */
