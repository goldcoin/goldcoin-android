...
import static com.google.goldcoin.core.Utils.*;

/**
 * <p>A transaction represents the movement of coins from some addresses to some other addresses. It can also represent
 * the minting of new coins. A Transaction object corresponds to the equivalent in the GoldCoin C++ implementation.</p>
 * <p/>
 * <p>Transactions are the fundamental atoms of GolsCoin and have many powerful features. Read
 ...
 * <p/>
 * <p>All GoldCoin transactions are at risk of being reversed, though the risk is much less than with traditional payment
...
public class Transaction extends ChildMessage implements Serializable {
    ...
    public static final BigInteger REFERENCE_DEFAULT_MIN_TX_FEE = GoldcoinDefinition.DEFAULT_MIN_TX_FEE;
    ...
    // These are serialized in both goldcoin and java serialization.
     ...
     * @param msg         goldcoin protocol formatted byte array containing message content.
     ...
     * value is determined by a formula that all implementations of goldcoin share. In 2011 the value of a coinbase
    ...
    public void clearInputs() {
        ...
        this.length = this.litecoinSerialize().length;
    }
    /**
     ...
     * features of goldcoin are developed.
     *
