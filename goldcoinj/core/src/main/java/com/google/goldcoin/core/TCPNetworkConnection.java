...
/**
 * <p>A {@code TCPNetworkConnection} is used for connecting to a goldcoin node over the standard TCP/IP protocol.<p>
 * <p/>
...
public class TCPNetworkConnection implements NetworkConnection {
    ...
    private void onVersionMessage(Message m) throws IOException, ProtocolException {
        ...
        // goldcoinj is a client mode implementation. That means there's not much point in us talking to other client
    ...
    public class NetworkHandler extends ReplayingDecoder<VoidEnum> implements ChannelDownstreamHandler {
        ...
        // Attempt to decode a goldcoin message passing upstream in the channel.
        //
        ...
        /**
         * Serialize outgoing goldcoin messages passing downstream in the channel.
         */
    ...
    /**
     * Returns the Netty Pipeline stage handling goldcoin serialization for this connection.
     */
