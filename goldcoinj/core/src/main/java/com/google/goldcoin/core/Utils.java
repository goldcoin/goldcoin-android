...
/**
 * A collection of various utility methods that are helpful for working with the goldcoin protocol.
 * To enable debug logging from the library, run with -Dgoldcoinj.logging=true on your command line.
 */
public class Utils {
    ...
    /**
     * The string that prefixes all text messages signed using goldcoin keys.
     */
    public static final String LITECOIN_SIGNED_MESSAGE_HEADER = "Goldcoin Signed Message:\n";

    // TODO: Replace this nanocoins business with something better.

    /**
     * How many "nanocoins" there are in a goldcoin.
     * <p/>
     * A nanocoin is the smallest unit that can be transferred using goldcoin.
    ...
    /**
     * How many "nanocoins" there are in 0.01 goldcoins.
     * <p/>
     * A nanocoin is the smallest unit that can be transferred using goldcoin.
     * The term nanocoin is very misleading, though, because there are only 100 million
     * of them in a coin (whereas one would expect 1 billion).
     ...
     * standard procedure in goldcoin. The resulting hash is in big endian form.
     */
     ...
     * <p/>
     * <tt><p>[24] "Goldcoin Signed Message:\n" [message.length as a varint] message</p></tt>
     */
