...
import com.google.goldcoin.core.StoredBlock;
 ...
 * <p/>
 * A BlockStore is a map of hashes to StoredBlock. The hash is the double digest of the goldcoin serialization
...
public interface BlockStore {
     ...
     * can be arbitrarily expensive, you probably should use {@link com.google.goldcoin.core.BlockChain#getChainHead()}
     * or perhaps {@link com.google.goldcoin.core.BlockChain#getBestChainHeight()} which will run in constant time and
