...
/**
 * <p>A GoldCoin address looks like DvRQ1LYunbXUN1A3dzULtibLiA9Koo3gmd and is derived from an elliptic curve public key
...
public class Address extends VersionedChecksummedBytes {
     ...
     * <p/>
     * <pre>new Address(NetworkParameters.prodNet(), "DvRQ1LYunbXUN1A3dzULtibLiA9Koo3gmd");</pre><p>
     *
     * @param params  The expected NetworkParameters or null if you don't want validation.
     * @param address The textual form of the address, such as "DvRQ1LYunbXUN1A3dzULtibLiA9Koo3gmd"
    ...
    /**
     * The (big endian) 20 byte hash that is the core of a goldcoin address.
     */
