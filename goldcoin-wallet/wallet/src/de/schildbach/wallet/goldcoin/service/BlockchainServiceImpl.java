...
package de.schildbach.wallet.goldcoin.service;
...
import com.google.goldcoin.store.SPVBlockStore;
import de.schildbach.wallet.goldcoin.Constants;
import de.schildbach.wallet.goldcoin.WalletApplication;
import de.schildbach.wallet.goldcoin.WalletBalanceWidgetProvider;
import de.schildbach.wallet.goldcoin.ui.WalletActivity;
import de.schildbach.wallet.goldcoin.util.ThrottelingWalletChangeListener;
...
public class BlockchainServiceImpl extends android.app.Service implements BlockchainService
{
	...
	private void notifyCoinsReceived(final Address from, final BigInteger amount)
	{
		...
		final int precision = Integer.parseInt(prefs.getString(Constants.PREFS_KEY_GLD_PRECISION, Integer.toString(Constants.GLD_PRECISION)));
