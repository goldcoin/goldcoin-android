...
public class Constants
{
	...
	private static final String EXTERNAL_WALLET_KEY_BACKUP_PROD = "goldcoin-wallet-keys";
	private static final String EXTERNAL_WALLET_KEY_BACKUP_TEST = "goldcoin-wallet-keys-testnet";
	...
	public static final String PEER_DISCOVERY_IRC_CHANNEL_PROD = "#goldcoin";
	public static final String PEER_DISCOVERY_IRC_CHANNEL_TEST = "#goldcoinTEST3";

	private static final String BLOCKEXPLORER_BASE_URL_PROD = "http://gld.cryptocoinexplorer.com/";
	private static final String BLOCKEXPLORER_BASE_URL_TEST = "http://gld.cryptocoinexplorer.com/";
	public static final String BLOCKEXPLORER_BASE_URL = TEST ? BLOCKEXPLORER_BASE_URL_TEST : BLOCKEXPLORER_BASE_URL_PROD;

	public static final String MIMETYPE_TRANSACTION = "application/x-gldtx";
	...
	public static final String CURRENCY_CODE_LITECOIN = "GLD";
	...
	public static final String SOURCE_URL = "based on bitcoin-wallet and litecoin-wallet";//https://github.com/hank/litecoin-wallet";
	public static final String BINARY_URL = "https://github.com/hank/litecoin-wallet";
	public static final String CREDITS_LITECOINJ_URL = "based on bitcoinj and litecoinj"; //http://code.google.com/p/litecoinj/";
	public static final String CREDITS_ZXING_URL = "http://code.google.com/p/zxing/";
    public static final String CREDITS_WEBSITE_URL = "http://gldcoin.com/";
    public static final String CREDITS_FORUM_URL = "http://gldtalk.org/";
	public static final String CREDITS_ICON_URL = "http://forum.litecoin.net/index.php?topic=1134.0";
	public static final String AUTHOR_TWITTER_URL = "https://twitter.com/GoldCoinInfo"; //"https://twitter.com/#!/bitcoins4life";
	public static final String AUTHOR_GOOGLEPLUS_URL = "https://plus.google.com/101537951445302000439/posts";///hardware.hank";
	...
	private static final String VERSION_URL_PROD = "http://wallet.gldcoin.com/version";
	private static final String VERSION_URL_TEST = "http://wallet.gldcoin.com/version_test";
	...
	public static final String PREFS_KEY_GLD_PRECISION = "gld_precision";
	public static final String PREFS_KEY_DISCLAIMER = "disclaimer";

    public static final BigInteger MIN_TX_FEE = Utils.toNanoCoins("0.10");
	public static final BigInteger DEFAULT_TX_FEE = MIN_TX_FEE;//Utils.CENT; // 0.01
