...
package de.schildbach.wallet.goldcoin.util;
...
import com.google.goldcoin.core.DumpedPrivateKey;
...
public class WalletUtils
{
	...
	public static BigInteger localValue(final BigInteger gldValue, final BigInteger rate)
	{
		return gldValue.multiply(rate).divide(Utils.COIN);
	}

	public static BigInteger gldValue(final BigInteger localValue, final BigInteger rate)
	{
