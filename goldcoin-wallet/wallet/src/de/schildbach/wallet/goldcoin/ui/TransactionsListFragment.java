...
public class TransactionsListFragment extends SherlockListFragment implements LoaderCallbacks<List<Transaction>>, OnSharedPreferenceChangeListener
{
	...
	{
		if (Constants.PREFS_KEY_GLD_PRECISION.equals(key))
			updateView();
	}

	private void updateView()
	{
		adapter.setPrecision(Integer.parseInt(prefs.getString(Constants.PREFS_KEY_GLD_PRECISION, Integer.toString(Constants.GLD_PRECISION))));
