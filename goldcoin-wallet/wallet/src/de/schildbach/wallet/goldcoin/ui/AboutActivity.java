...
import com.google.goldcoin.core.VersionMessage;
...
public final class AboutActivity extends SherlockPreferenceActivity
{
	...
	private static final String KEY_ABOUT_CREDITS_LITECOINJ = "about_credits_goldcoinj";
	...
	protected void onCreate(final Bundle savedInstanceState)
	{
		...
		findPreference(KEY_ABOUT_CREDITS_LITECOINJ).setTitle(getString(R.string.about_credits_goldcoinj_title, VersionMessage.GOLDCOINJ_VERSION));
