...
package de.schildbach.wallet.goldcoin.integration.android;
 ...
 */
public final class GoldcoinIntegration
{
	private static final String INTENT_EXTRA_TRANSACTION_HASH = "transaction_hash";

	/**
	 * Request any amount of Goldcoins (probably a donation) from user, without feedback from the app.
	 * 
	 * @param context
	 *            Android context
	 * @param address
	...
	/**
	 * Request specific amount of Goldcoins from user, without feedback from the app.
	 * 
	 * @param context
	 *            Android context
	 * @param address
	...
	/**
	 * Request any amount of Goldcoins (probably a donation) from user, with feedback from the app. Result intent can be
	 ...
	 * 
	 * Warning: A success indication is no guarantee! To be on the safe side, you must drive your own Goldcoin
	...
	/**
	 * Request specific amount of Goldcoins from user, with feedback from the app. Result intent can be received by
	...
	/**
	 * Put transaction hash into result intent. Meant for usage by Goldcoin wallet applications.
	 * 
	 * @param result
	 *            result intent
	 * @param txHash
	...
	/**
	 * Get transaction hash from result intent. Meant for usage by applications initiating a Goldcoin payment.
	 * 
	 * You can use this hash to request the transaction from the Goldcoin network, in order to validate. For this, you
	 * need your own Goldcoin infrastructure though. There is no guarantee that the transaction has ever been broadcasted
	 * to the Goldcoin network.
	 * 
	 * @param result
	 *            result intent
	...
	{
		Toast.makeText(context, "No Goldcoin application found.\nPlease install Goldcoin Wallet.", Toast.LENGTH_LONG).show();
